...
export class FileUploadService {
  ...
  async uploadFile(file: UploadedFile, bucket: 'workshops' | 'parts'): Promise<string> {
    try {
  ...
  async uploadMultipleFiles(files: UploadedFile[], bucket: 'workshops' | 'parts'): Promise<string[]> {
