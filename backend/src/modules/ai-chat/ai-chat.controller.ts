...
export class AiChatController {
  ...
  async suggestWorkshops(@Body() body: { message: string }) {
    const suggestion = await this.aiChatService.generateWorkshopSuggestion(
      body.message,
    );
    return {
      success: true,
  ...
  async suggestParts(@Body() body: { message: string }) {
    const suggestion = await this.aiChatService.generatePartsSuggestion(
      body.message,
    );
    return {
      success: true,
