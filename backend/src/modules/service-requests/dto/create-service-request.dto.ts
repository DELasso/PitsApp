...
class HomeServiceDetailsDto implements HomeServiceDetails {
  ...
  @IsOptional()
  @IsEnum(['house', 'apartment', 'building'], { message: 'El tipo de unidad debe ser casa, apartamento o edificio' })
  unitType?: 'house' | 'apartment' | 'building';

  @IsOptional()
  @IsString({ message: 'El número de unidad debe ser un texto' })
  @MaxLength(20, { message: 'El número de unidad no puede exceder 20 caracteres' })
  unitNumber?: string;
  ...
  @MaxLength(300, { message: 'Las indicaciones adicionales no pueden exceder 300 caracteres' })
...
class TowTruckDetailsDto implements TowTruckDetails {
  ...
  @MinLength(5, { message: 'La dirección de recogida debe tener al menos 5 caracteres' })
  pickupAddress: string;

  @IsString({ message: 'La ciudad de recogida debe ser un texto' })
  @IsNotEmpty({ message: 'La ciudad de recogida es obligatoria' })
  @MinLength(2, { message: 'La ciudad de recogida debe tener al menos 2 caracteres' })
  pickupCity: string;
  ...
  @MinLength(2, { message: 'La ciudad de entrega debe tener al menos 2 caracteres' })
  deliveryCity: string;
  ...
  @IsEnum(['running', 'not_running', 'accident'], { message: 'La condición del vehículo debe ser válida' })
  ...
  @MaxLength(500, { message: 'La información adicional no puede exceder 500 caracteres' })
...
class OilChangeDetailsDto implements OilChangeDetails {
  ...
  @MaxLength(50, { message: 'La marca de aceite no puede exceder 50 caracteres' })
  preferredOilBrand?: string;

  @IsOptional()
  @IsEnum(['synthetic', 'semi-synthetic', 'conventional'], { message: 'El tipo de aceite debe ser válido' })
  ...
  @IsOptional()
  @IsString({ each: true, message: 'Cada servicio adicional debe ser un texto' })
...
class DiagnosisDetailsDto implements DiagnosisDetails {
  ...
  @MaxLength(100, { message: 'Esta información no puede exceder 100 caracteres' })
  whenStarted?: string;

  @IsOptional()
  @IsString({ each: true, message: 'Cada luz de advertencia debe ser un texto' })
  warningLights?: string[];

  @IsOptional()
  @IsString({ message: 'Las reparaciones recientes deben ser un texto' })
  @MaxLength(300, { message: 'Las reparaciones recientes no pueden exceder 300 caracteres' })
...
class RepairDetailsDto implements RepairDetails {
  ...
  @IsOptional()
  @IsString({ each: true, message: 'Cada parte afectada debe ser un texto' })
  affectedParts?: string[];

  @IsOptional()
  @IsString({ message: 'El diagnóstico previo debe ser un texto' })
  @MaxLength(300, { message: 'El diagnóstico previo no puede exceder 300 caracteres' })
  ...
  @IsOptional()
  @IsEnum(['original', 'aftermarket', 'used'], { message: 'El tipo de repuesto preferido debe ser válido' })
